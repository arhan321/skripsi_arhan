    ...
    <body class="min-h-screen bg-slate-100 text-slate-950 antialiased">
        <div class="soft-grid min-h-screen">
            ...
            <header class="sticky top-0 z-40 border-b border-white/20 bg-white/80 backdrop-blur-xl">
                <div
                    class="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-4 md:flex-row md:items-center md:justify-between"
                >
                    <div class="flex items-start gap-3">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-slate-950 to-blue-700 text-xl font-black text-white shadow-lg shadow-blue-900/20"
                        >
                            T
                        </div>

                        <div>
                            <h1 class="text-2xl font-black tracking-tight text-slate-950">TourHub Bali</h1>

                            <p class="text-sm font-medium text-slate-600">Simulasi Web Rekomendasi Wisata CBF + CARS</p>
                ...
                <div class="relative mx-auto max-w-7xl px-6 py-8 md:py-10">
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:items-end">
                        <div class="lg:col-span-2">
                            <div
                                class="inline-flex rounded-full bg-white/10 px-3 py-1 text-xs font-bold text-blue-100 ring-1 ring-white/10"
                            >
                            ...
                            <p class="mt-4 max-w-2xl text-sm leading-6 text-slate-300 md:text-base">
                                Sistem ini menggabungkan Content-Based Filtering untuk kecocokan preferensi dan
                                Context-Aware Recommender System untuk menyesuaikan ranking berdasarkan cuaca, hari
                                kunjungan, dan high season.
                            </p>
                        </div>
            ...
            <main class="mx-auto max-w-7xl px-6 py-8">
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                    ...
                    <aside class="lg:col-span-4 xl:col-span-4">
                        <div
                            class="premium-shadow sticky top-28 overflow-hidden rounded-3xl border border-slate-200 bg-white"
                        >
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-2 gap-2">
                                            @foreach (['Alam' => '🌿', 'Budaya' => '🏛️', 'Rekreasi' => '🎡', 'Umum' => '✨'] as $kategori => $icon)
                                                <label
                                                    class="group flex cursor-pointer items-center gap-2 rounded-2xl border border-slate-200 bg-white px-3 py-3 text-sm font-semibold transition hover:border-blue-300 hover:bg-blue-50"
                                                >
                                                    <input
                                                        type="checkbox"
                                        ...
                                        <div class="mb-3 flex items-center justify-between gap-3">
                                            <div>
                                                ...
                                                <p class="text-xs text-slate-500">
                                                    Digunakan untuk filter dataset dan ADM4 BMKG.
                                                </p>
                                            </div>
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="mt-2 text-xs leading-5 text-slate-500">
                                                    Contoh aman untuk BMKG otomatis:
                                                    <strong>Ubud</strong>
                                                    ,
                                                    <strong>Kuta</strong>
                                                    ,
                                                    <strong>Kintamani</strong>
                                                    ,
                                                    <strong>Denpasar Selatan</strong>
                                                    .
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <div>
                                            <label
                                                for="min_rating"
                                                class="mb-1 block text-sm font-black text-slate-800"
                                            >
                                                Min Rating
                                            </label>
                                    ...
                                    <div class="rounded-3xl border border-blue-100 bg-blue-50/70 p-4">
                                        <div class="mb-3 flex items-center gap-2">
                                            <span
                                                class="flex h-9 w-9 items-center justify-center rounded-2xl bg-blue-100"
                                            >
                                                🌦️
                                            </span>
                                        ...
                                        <div class="mt-4 space-y-3">
                                            <label
                                                class="flex cursor-pointer items-center justify-between rounded-2xl bg-white px-4 py-3 ring-1 ring-blue-100"
                                            >
                                                <span>
                                            ...
                                            <div
                                                class="rounded-2xl border border-blue-200 bg-white p-4 text-xs leading-5 text-blue-800"
                                            >
                                                <div class="flex items-start gap-3">
                                                    <div
                                                        class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-blue-100"
                                                    >
                                                        ℹ️
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mt-1">
                                                            Jika opsi
                                                            <strong>Gunakan BMKG</strong>
                                                            aktif, sistem mengambil
                                                            <strong>prakiraan cuaca BMKG</strong>
                                                            berdasarkan wilayah kabupaten/kota dan kecamatan yang
                                                            dipilih. Data BMKG merupakan prakiraan cuaca beberapa hari
                                                            ke depan, sehingga hasil rekomendasi akan menyesuaikan
                                                            kondisi cuaca dari data prakiraan tersebut.
                                                        </p>

                                                        <p class="mt-2">
                                                            User tidak perlu mengisi kode ADM4. Sistem akan menentukan
                                                            ADM4 secara otomatis dari lokasi yang dipilih.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <section class="space-y-6 lg:col-span-8 xl:col-span-8">
                        @isset($result)
                            ...
                            <div class="premium-shadow overflow-hidden rounded-3xl border border-slate-200 bg-white">
                                ...
                                >
                                    <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                        ...
                                        <span
                                            class="inline-flex rounded-2xl bg-blue-600 px-4 py-2 text-sm font-black text-white shadow-sm shadow-blue-600/30"
                                        >
                                ...
                                <div class="p-6">
                                    @if ($bestRecommendation)
                                        ...
                                        <div
                                            class="mb-6 overflow-hidden rounded-3xl border border-amber-200 bg-gradient-to-br from-amber-50 via-white to-blue-50 shadow-lg shadow-amber-900/5"
                                        >
                                            <div class="grid grid-cols-1 lg:grid-cols-12">
                                                <div class="relative lg:col-span-5">
                                                    ...
                                                    @else
                                                        <div
                                                            class="flex h-80 w-full items-center justify-center bg-gradient-to-br from-amber-100 to-blue-100 text-sm font-bold text-slate-500 lg:h-full"
                                                        >
                                                            No Image
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div
                                                        class="absolute top-4 left-4 rounded-2xl bg-amber-400 px-4 py-2 text-sm font-black text-slate-950 shadow-lg shadow-amber-900/20"
                                                    >
                                                        🏆 Paling Direkomendasikan
                                                    </div>

                                                    <div
                                                        class="absolute right-4 bottom-4 left-4 rounded-3xl bg-white/90 p-4 backdrop-blur-xl"
                                                    >
                                                        <p
                                                        ...
                                                        <p
                                                            class="mt-1 text-4xl font-black tracking-tight text-slate-950"
                                                        >
                                                ...
                                                <div class="p-6 md:p-8 lg:col-span-7">
                                                    <div
                                                    ...
                                                    >
                                                        <div>
                                                            ...
                                                            <h3
                                                                class="mt-4 text-3xl font-black tracking-tight text-slate-950"
                                                            >
                                                    ...
                                                    <div
                                                        class="mt-6 rounded-2xl border border-amber-200 bg-white/80 p-4"
                                                    >
                                                        <p
                                                        ...
                                                        <p class="mt-2 text-sm leading-6 text-slate-700">
                                                            ...
                                                            dibanding kandidat lainnya. Final score dihitung dari
                                                            kecocokan CBF, kualitas rating, jumlah ulasan, dan
                                                            penyesuaian konteks CARS.
                                                        </p>
                                    ...
                                    <div class="space-y-5">
                                        @forelse ($recommendations as $index => $item)
                                            <article
                                                class="group {{ $index === 0 ? 'border-amber-300 bg-amber-50/40' : 'border-slate-200 bg-white' }} overflow-hidden rounded-3xl border transition hover:-translate-y-0.5 hover:shadow-xl hover:shadow-slate-900/10"
                                            >
                                                <div class="grid grid-cols-1 md:grid-cols-12">
                                                    <div class="relative md:col-span-4">
                                                        ...
                                                        @else
                                                            <div
                                                                class="flex h-64 w-full items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200 text-sm font-bold text-slate-400 md:h-full"
                                                            >
                                                                No Image
                                                            </div>
                                                        @endif
                                                        ...
                                                        <div
                                                            class="absolute right-4 bottom-4 left-4 rounded-2xl bg-white/90 p-3 backdrop-blur"
                                                        >
                                                    ...
                                                    <div class="p-5 md:col-span-8 md:p-6">
                                                        <div
                                                            class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between"
                                                        >
                                                            <div>
                                        ...
                                        @empty
                                            ...
                                            >
                                                ...
                                                <p class="mt-2 text-sm text-slate-500">
                                                    Coba kosongkan keyword, turunkan min rating, atau pilih semua
                                                    kategori.
                                                </p>
                                            </div>
                                        @endforelse
                            ...
                            {{-- JSON Debug --}}
                            <details
                                class="premium-shadow overflow-hidden rounded-3xl border border-slate-200 bg-white"
                            >
                                <summary
