...
<body class="min-h-screen bg-slate-100 text-slate-950 antialiased">
    <div class="min-h-screen soft-grid">
            ...
            <div class="mx-auto max-w-7xl px-6">
                <div class="flex min-h-[72px] flex-col gap-4 py-4 md:flex-row md:items-center md:justify-between">
                    <a href="{{ route('user.dashboard') }}" class="flex items-center gap-3">
                        <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-slate-950 to-blue-700 text-xl font-black text-white shadow-lg shadow-blue-900/20">
                            T
                        </div>
                    ...
                    <div class="flex flex-wrap items-center gap-2 text-sm font-bold">
                        <span class="hidden rounded-2xl bg-slate-50 px-4 py-2.5 text-xs text-slate-600 ring-1 ring-slate-200 lg:inline-flex">
                            ML API: <span class="ml-1 text-slate-900">{{ $defaultBaseUrl ?? '-' }}</span>
                        </span>

                        @auth
                            <span class="hidden rounded-2xl bg-slate-50 px-4 py-2.5 text-xs text-slate-600 ring-1 ring-slate-200 xl:inline-flex">
                                {{ auth()->user()->name }}
                            </span>
                        @endauth
                ...
                <nav class="hide-scrollbar flex gap-7 overflow-x-auto border-t border-slate-100 py-3 text-sm font-black text-slate-600">
                    <a href="#search" data-scroll-link class="nav-scroll-link is-active whitespace-nowrap">Rekomendasi</a>
        ...
        <section id="search" class="section-anchor relative overflow-hidden bg-slate-950">
            ...
            <div class="relative mx-auto max-w-7xl px-6 pb-12 pt-10 md:pb-20 md:pt-12">
                <div class="mx-auto max-w-4xl text-center">
                    <div class="inline-flex rounded-full bg-white/10 px-4 py-2 text-xs font-black text-blue-100 ring-1 ring-white/10">
                    ...
                    <p class="mx-auto mt-4 max-w-2xl text-sm leading-6 text-slate-300 md:text-base">
                        Cari destinasi wisata berdasarkan preferensi, lokasi, rating, cuaca, hari kunjungan, dan kondisi high season.
                    </p>
                </div>

                <div class="mx-auto mt-8 max-w-6xl">
                    <div class="mb-4 grid grid-cols-4 gap-2 text-center text-xs font-black text-slate-200 md:grid-cols-8 md:gap-4">
                    ...
                    <div class="overflow-hidden rounded-[2rem] border border-white/20 bg-white hero-search-shadow">
                        <div class="border-b border-slate-100 bg-gradient-to-br from-white to-slate-50 p-5 md:p-6">
                            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                                ...
                                <div class="grid grid-cols-2 gap-2 text-xs font-black md:flex">
                                    ...
                                    <span class="rounded-2xl bg-blue-100 px-3 py-2 text-blue-700">BMKG / Manual</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-5 md:p-6">
                            ...
                            <form method="POST" action="{{ route('tourhub.recommendation.store') }}" class="space-y-5">
                                ...
                                <div id="kategori" class="section-anchor">
                                    ...
                                    <div class="grid grid-cols-2 gap-3 md:grid-cols-4">
                                        @foreach ([
                                            ...
                                            <label class="group relative cursor-pointer overflow-hidden rounded-3xl border border-slate-200 bg-white p-4 transition hover:-translate-y-0.5 hover:border-blue-300 hover:bg-blue-50">
                                                <input
                                                    type="checkbox"
                                                ...
                                                <div class="absolute right-3 top-3 hidden h-6 w-6 items-center justify-center rounded-full bg-blue-600 text-xs font-black text-white peer-checked:flex">
                                                    ✓
                                                </div>

                                                <div class="text-3xl">{{ $meta['icon'] }}</div>
                                                <p class="mt-3 text-sm font-black text-slate-950">{{ $kategori }}</p>
                                                <p class="mt-1 text-xs leading-5 text-slate-500">{{ $meta['desc'] }}</p>
                                            </label>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 gap-3 lg:grid-cols-12">
                                    ...
                                    <div class="lg:col-span-4">
                                        <label for="keywords" class="mb-1 block text-xs font-bold uppercase tracking-wide text-slate-500">
                                            Keywords
                                        </label>
                                ...
                                <div class="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-4">
                                    <div>
                                        <label for="min_rating" class="mb-1 block text-xs font-bold uppercase tracking-wide text-slate-500">
                                            Min Rating
                                        </label>
                                    ...
                                    <div>
                                        <label for="top_n" class="mb-1 block text-xs font-bold uppercase tracking-wide text-slate-500">
                                            Top N
                                        </label>
                                ...
                                <div id="bmkg" class="section-anchor grid grid-cols-1 gap-3 lg:grid-cols-12">
                                    <label class="flex cursor-pointer items-center justify-between rounded-3xl border border-blue-100 bg-blue-50/70 px-4 py-4 lg:col-span-4">
                                        <span class="flex items-start gap-3">
                                            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-blue-100 text-xl">
                                                🌦️
                                            </span>
                                            <span>
                                                <span class="block text-sm font-black text-slate-900">Gunakan BMKG</span>
                                                <span class="text-xs leading-5 text-slate-500">Ambil prakiraan cuaca otomatis berdasarkan wilayah.</span>
                                            </span>
                                        </span>
                                    ...
                                    <label class="flex cursor-pointer items-center justify-between rounded-3xl border border-slate-200 bg-white px-4 py-4 lg:col-span-4">
                                        <span class="flex items-start gap-3">
                                            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-slate-100 text-xl">
                                                🧳
                                            </span>
                                            <span>
                                                <span class="block text-sm font-black text-slate-900">High Season</span>
                                                <span class="text-xs leading-5 text-slate-500">Simulasi kondisi ramai wisatawan.</span>
                                            </span>
                                        </span>
                                    ...
                                    <div class="rounded-3xl border border-blue-200 bg-white p-4 text-xs leading-5 text-blue-800 lg:col-span-4">
                                        <p class="font-black text-blue-900">Catatan BMKG</p>
                                        <p class="mt-1">
                                            User tidak perlu mengisi kode ADM4. Sistem akan menentukan ADM4 secara otomatis dari lokasi yang dipilih.
                                        </p>
                                    </div>
                                </div>
        ...
        <main class="mx-auto max-w-7xl px-6 py-8">
            ...
            <section id="hasil" class="section-anchor space-y-6">
                @isset($result)
                    ...
                    <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white premium-shadow">
                            ...
                            <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                <div>
                                    ...
                                    <p class="mt-2 text-sm leading-6 text-slate-600">
                                        Hasil ini sudah diurutkan berdasarkan final score tertinggi. Ranking #1 adalah destinasi paling direkomendasikan.
                                    </p>
                                ...
                                <div class="rounded-3xl bg-white p-4 text-center shadow-sm ring-1 ring-slate-200">
                                    <p class="text-xs font-bold uppercase tracking-wide text-slate-500">Total Output</p>
                                    <p class="mt-1 text-3xl font-black text-slate-950">{{ $recommendations->count() }}</p>
                        ...
                        <div class="p-6">
                            @if ($bestRecommendation)
                                <div class="mb-8 overflow-hidden rounded-[2rem] border border-amber-200 bg-gradient-to-br from-amber-50 via-white to-blue-50 shadow-lg shadow-amber-900/5">
                                    <div class="grid grid-cols-1 lg:grid-cols-12">
                                        <div class="relative min-h-[340px] lg:col-span-6">
                                            ...
                                            <div class="absolute bottom-5 left-5 right-5 text-white">
                                                <p class="text-xs font-black uppercase tracking-wider text-blue-100">Final Score Tertinggi</p>
                                                <div class="mt-2 flex items-end justify-between gap-4">
                                                    ...
                                                    <div class="rounded-3xl bg-white/90 px-5 py-3 text-right text-slate-950 backdrop-blur-xl">
                                                        <p class="text-xs font-bold text-slate-500">Score</p>
                                                        <p class="text-3xl font-black">{{ data_get($bestRecommendation, 'final_score') }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-6 md:p-8 lg:col-span-6">
                                            ...
                                            <div class="mt-6 grid grid-cols-2 gap-3 md:grid-cols-4">
                                                ...
                                                <div class="rounded-2xl bg-white p-4 ring-1 ring-slate-200">
                                                    <p class="text-xs font-bold uppercase tracking-wide text-slate-500">Ulasan</p>
                            ...
                            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                                @forelse ($recommendations as $index => $item)
                                    <article class="group overflow-hidden rounded-3xl border {{ $index === 0 ? 'border-amber-300 bg-amber-50/40' : 'border-slate-200 bg-white' }} transition hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-900/10">
                                        ...
                                        <div class="p-5">
                                            ...
                                            <h3 class="mt-3 line-clamp-2 text-xl font-black tracking-tight text-slate-950">
                                ...
                                @empty
                                    <div class="rounded-3xl border border-dashed border-slate-300 bg-slate-50 p-10 text-center md:col-span-2 xl:col-span-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div class="p-8 md:p-10">
                                ...
                                <p class="mt-3 text-sm leading-6 text-slate-600">
                                    Isi parameter pada kotak pencarian di atas untuk mendapatkan rekomendasi wisata Bali.
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                        <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white premium-shadow">
                            ...
                            <div class="p-5">
                                ...
                                <p class="mt-2 text-sm leading-6 text-slate-500">Cocok untuk pantai, air terjun, dan pegunungan.</p>
                            </div>
                        </div>
                        ...
                        <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white premium-shadow">
                            ...
                            <div class="p-5">
                                ...
                                <p class="mt-2 text-sm leading-6 text-slate-500">Cocok untuk pura, desa adat, dan wisata sejarah.</p>
                            </div>
                        </div>
                        ...
                        <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white premium-shadow">
                            ...
                            <div class="p-5">
                                ...
                                <p class="mt-2 text-sm leading-6 text-slate-500">Cocok untuk aktivitas keluarga dan tempat populer.</p>
                            </div>
                        </div>
                    </div>
                @endisset
            ...
            {{-- Latest Logs --}}
            <section id="log" class="section-anchor mt-8 overflow-hidden rounded-[2rem] border border-slate-200 bg-white premium-shadow">
