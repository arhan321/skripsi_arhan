            ...
            <section class="relative hidden overflow-hidden bg-slate-950 p-10 text-white lg:flex lg:flex-col lg:justify-between">
                ...
                <div class="relative">
                    ...
                    <p class="mt-4 max-w-md text-sm leading-6 text-slate-300">
                        Masuk untuk mencari rekomendasi wisata Bali berbasis Content-Based Filtering
                        dan Context-Aware Recommender System.
                    </p>
                </div>
                ...
                <div class="w-full max-w-md">
                    <div class="mb-8 text-center lg:text-left">
                        ...
                        <p class="mt-3 text-sm leading-6 text-slate-600">
                            Login untuk melihat rekomendasi wisata, menyimpan riwayat pencarian,
                            dan membuka dashboard user.
                        </p>
                    </div>
